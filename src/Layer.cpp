...
// FOR TESTING
template <typename T> Layer<T>::Layer(int numInputs, int numNeurons, int num) {
...
template <typename T> Layer<T>::Layer(int numInputs, int numNeurons) {
...
template <typename T> void Layer<T>::compute(const Vec2d<T> &pInputs) {
    inputs = pInputs;
...
template <typename T> void Layer<T>::backward(const Vec2d<T> &dValues) {
...
template <typename T> Vec2d<T> &Layer<T>::getOutput() { return output; }

template <typename T> Vec2d<T> &Layer<T>::getWeights() { return weights; }

template <typename T> Vec2d<T> &Layer<T>::getBiases() { return biases; }

template <typename T> Vec2d<T> &Layer<T>::getDWeights() { return dWeights; }

template <typename T> Vec2d<T> &Layer<T>::getDBiases() { return dBiases; }

template <typename T> Vec2d<T> &Layer<T>::getDInputs() { return dInputs; }

template <typename T> Vec2d<T> &Layer<T>::getWeightMomentums() {
    return weightMomentums;
}

template <typename T> Vec2d<T> &Layer<T>::getBiasMomentums() {
    return biasMomentums;
}

template <typename T> Vec2d<T> &Layer<T>::getWeightCache() {
    return weightCache;
}

template <typename T> Vec2d<T> &Layer<T>::getBiasCache() { return biasCache; }
...
template <typename T> void Layer<T>::setWeights(const Vec2d<T> &newWeights) {
    weights = newWeights;
}

template <typename T> void Layer<T>::setBiases(const Vec2d<T> &newBiases) {
    biases = newBiases;
}
